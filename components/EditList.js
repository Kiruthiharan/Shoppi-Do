...
const EditList = props => {
  const [enteredList, setEnteredList] = useState(props.item.title);
  const [checked, setChecked] = useState(props.item.color);
    console.log(props)
  ...
  const handleSubmit = () => {
    props.editList(enteredList, checked);
    setEnteredList('');
    props.close();
  };
  ...
  return (
    <View>
      ...
      <View style={styles.content}>
        <Text style={styles.contentTitle}>Edit List!</Text>
        <TextInput
          style={styles.input}
          value={enteredList}
